...
const PARTICLES_OPTIONS = {
  ...
  particles: {
    ...
    links: { enable: true, distance: 100, color: '#eaeaea', opacity: 0.4, width: 1 },
...
const SOCIAL_LINKS = [
  { href: 'https://github.com/Shivanijai1201', icon: 'fa-brands fa-github', accent: '#ffffff' },
...
function Hero() {
  ...
  return (
    <section className="relative flex justify-center overflow-hidden bg-black px-0 pt-32 pb-12" id="home">
      <ParticlesProvider init={initParticles}>
        <Particles id="particles-js" options={PARTICLES_OPTIONS} />
      </ParticlesProvider>
      ...
      <div className="relative z-10 flex w-[90%] max-w-6xl flex-col-reverse items-center justify-between gap-16 md:flex-row md:items-end">
        <div className="flex w-full flex-col items-start gap-8 md:w-auto" data-aos="fade-up">
          <div className="text-2xl font-medium text-white">Hi!</div>
          <div className="text-3xl leading-tight text-white md:text-4xl">
            I'm <span className="font-extrabold text-primary" ref={typedRef}></span>
          </div>
          <div className="max-w-xl text-lg font-medium text-white">
          ...
          <Link
            to="/contact"
            className="inline-block w-max rounded-full bg-primary px-8 py-2 text-sm tracking-widest text-white uppercase transition-all hover:-translate-y-1 hover:bg-primary-dark hover:text-black hover:shadow-[0_10px_25px_rgba(0,204,255,0.35)]"
          >
            Hire me
          </Link>
