...
function Footer() {
  return (
    <footer>
      <div className="relative flex w-full items-center justify-center overflow-hidden border-t border-primary/15 bg-paper px-0 py-12">
        ...
        <div className="relative flex w-[90%] max-w-6xl flex-col items-center gap-8">
          <div className="flex w-full flex-wrap items-center justify-between gap-8 max-[800px]:flex-col max-[800px]:text-center">
            <div className="flex flex-col items-start gap-1.5 text-left max-[800px]:items-center max-[800px]:text-center">
              <Link to="/" className="inline-flex items-center text-2xl font-bold text-ink no-underline">
                <span className="text-3xl font-extrabold text-primary">S</span>hivani Jayshwal
              </Link>
              <p className="text-sm text-ink/50">Building fast, reliable software — one feature at a time.</p>
            ...
            <div className="flex flex-col items-end gap-3.5 max-[800px]:items-center">
              <p className="text-xs font-bold tracking-[2px] text-ink/50 uppercase">Stay Connected</p>
              <div className="flex items-center gap-5">
                {SOCIAL_LINKS.map((social) => (
                  <a
                    ...
                    rel="noreferrer"
                    className="flex h-11.5 w-11.5 items-center justify-center rounded-full border border-ink/8 bg-ink/4 text-xl transition-all hover:-translate-y-1 hover:border-primary hover:shadow-[0_8px_20px_rgba(0,204,255,0.2)]"
                  >
          ...
          <div className="w-full border-t border-ink/8 pt-6 text-center text-ink">
